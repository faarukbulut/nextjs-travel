...
const Hero = () => {
    ...
    return (
        <div className='releative bg-hero-swipe py-16'>
            <div className='container mx-auto px-4 flex flex-col lg:flex-row items-center'>
                ...
                <div className='lg:w-1/2 space-y-6 text-center lg:text-left px-6 transition-all duration-500'>
                    ...
                    <Button className='bg-orange-500 hover:bg-orange-600'>{slides[currentSlide].buttonText}</Button>
                </div>
                    ...
                    >
                        {slides.map((slide, index) => (
                            <SwiperSlide key={index}>
                                <div className='releative rounded-3xl overflow-hidden'>
                                    <Image src={slide.image} alt={slide.title} width={800} height={600} className='w-full h-auto object-cover' />
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
