...
const RecentProduct = () => {
  return (
    <div>
        <Carousel opts={{align: "start", loop: true}} plugins={[Autoplay({delay: 2000})]} className='container mx-auto px-10 lg:px-36'>
            <CarouselContent>
                        ...
                        <div className='p-3'>
                            <Card>
                                <CardHeader className='releative'>
                                    <Image src={pkg.image} height={500} width={500} alt='' className='w-full h-48 object-cover rounded-t-lg' />
                                    {pkg.discount && (
            ...
            <CarouselPrevious className='left-0 bg-orange-500 hover:bg-orange-600 hover:text-white text-white py-4 px-4' />
            <CarouselNext className='right-0 bg-orange-500 hover:bg-orange-600 hover:text-white text-white py-4 px-4' />
        </Carousel>
    </div>
  )
}
